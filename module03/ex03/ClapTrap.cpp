...
ClapTrap::ClapTrap()
: _name("Anonymous"), _hitPoints(_start_hitPoints), _energy(_start_energy), _damage(_start_damage)
{
	std::cout << "An Anonymous ClapTrap was created" << std::endl;
}

ClapTrap::ClapTrap(const std::string name)
: _name(name), _hitPoints(_start_hitPoints), _energy(_start_energy), _damage(_start_damage)
{
